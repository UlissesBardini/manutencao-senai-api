...
public class TelaOrdemDeServico extends JFrame implements Serializable {
	...
	public TelaOrdemDeServico() throws ParseException {
		...
		cbTecnico = new JComboBox<Tecnico>();

		JLabel lblNewLabel_2 = new JLabel("Abertura");

		JFormattedTextField fmtAbertura = new JFormattedTextField(new MaskFormatter("##/##/####"));

		JFormattedTextField ftmEncerramento = new JFormattedTextField(new MaskFormatter("##/##/####"));
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				LocalDate dataDeAbertura = LocalDate.of(Integer.parseInt(camposDaData[2]),
				...
				JOptionPane.showMessageDialog(contentPane, "Ordem salva com sucesso");
			}
		});
						...
						.addGroup(gl_contentPane.createSequentialGroup().addContainerGap()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(Alignment.TRAILING,
												gl_contentPane.createSequentialGroup().addComponent(jtaProblema,
										...
										.addComponent(cbTecnico, 0, 570, Short.MAX_VALUE).addComponent(lblNewLabel)
										.addComponent(lblNewLabel_1)
										.addGroup(gl_contentPane
												.createSequentialGroup()
												.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
														.addComponent(fmtAbertura, GroupLayout.PREFERRED_SIZE, 168,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(lblNewLabel_2))
												.addPreferredGap(ComponentPlacement.RELATED)
												.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
														.addComponent(lblNewLabel_3)
														.addComponent(ftmEncerramento, GroupLayout.PREFERRED_SIZE, 168,
																GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_contentPane.createSequentialGroup().addComponent(lblNewLabel_4)
												.addGap(138).addComponent(lblNewLabel_5))
										.addComponent(cbCliente, 0, 570, Short.MAX_VALUE).addComponent(lblNewLabel_6)
										.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
												.addComponent(cbPeca, 0, 476, Short.MAX_VALUE)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnAddPeca))
										.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 570, Short.MAX_VALUE)))
						.addGroup(gl_contentPane.createSequentialGroup().addGap(390).addComponent(btnRemoverPeca,
								GroupLayout.DEFAULT_SIZE, 192, Short.MAX_VALUE))
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
								.addContainerGap(484, Short.MAX_VALUE).addComponent(btnSalvar)))
				.addContainerGap()));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(
						cbTecnico, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED)
				...
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane
						.createParallelGroup(Alignment.LEADING).addComponent(lblNewLabel_4).addComponent(lblNewLabel_5))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
				...
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblNewLabel_6)
				.addPreferredGap(ComponentPlacement.RELATED)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(cbPeca, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(btnAddPeca))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 147, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnRemoverPeca)
				.addPreferredGap(ComponentPlacement.RELATED, 19, Short.MAX_VALUE).addComponent(btnSalvar)));
